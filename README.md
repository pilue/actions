...
Sends an HMAC-signed publish request to the platform-api, triggering a build and deploy via `dsbibby/hetzner-k3s`.
...
|---|---|---|
| `domain` | yes | Registered domain, e.g. `matthewsbirdtables.pilue.co.uk` |
